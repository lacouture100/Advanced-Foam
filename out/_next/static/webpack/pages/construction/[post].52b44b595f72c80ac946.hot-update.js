...
function Post(_ref) {
  ...
  }, postData.title.rendered), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
Post.getInitialProps = /*#__PURE__*/function () {
  var _ref2 = Object(_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(context) {
    var query, wpCategoryFilter, LINK, response, postData;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            query = context.query; // This is the construction category number in wordpress

            wpCategoryFilter = 16;
            LINK = "https://www.advancedfoam.com/wp-json/wp/v2/posts?categories=".concat(wpCategoryFilter, "&slug=").concat(query.post); //console.log(LINK);

            _context.next = 5;
            return axios__WEBPACK_IMPORTED_MODULE_5___default.a.get("https://www.advancedfoam.com/wp-json/wp/v2/posts?categories=".concat(wpCategoryFilter, "&slug=").concat(query.post));
